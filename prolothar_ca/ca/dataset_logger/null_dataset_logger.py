...
class NullDatasetLogger(DatasetLogger):
    """
    a dataset logger that by definition does nothing, i.e. it implements the null object pattern
    """

    def log_dataset(self, dataset: CaDataset, dataset_name: str):
        #as the class name suggests do nothing
        pass